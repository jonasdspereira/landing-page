    ...
    <div className="App">
        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarResponsive">
            <ul className="navbar-nav text-uppercase ml-auto">
              ...
              <li className="nav-item">
                <a className="nav-link js-scroll-trigger" href="#team">Time</a>
              </li>
              <li className="nav-item">
      ...
      <header className="masthead">
        <div className="container">
          <div className="intro-text">
            <div className="intro-lead-in">Bem-vindos a</div>
            <div className="intro-heading">Agencia Tecnet</div>
        ...
        <div className="container">
          ...
          <div className="row text-center">
            <div className="col-md-4">
              ...
              <h4 className="service-heading">Desenvolvimento de Sites</h4>
            ...
            <div className="col-md-4">
              ...
              <h4 className="service-heading">Design Responsivo</h4>
              <p className="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam architecto quo inventore harum ex magni, dicta impedit.</p>
            </div>
            <div className="col-md-4">
              <span className="fa-stack fa-4x">
              ...
              <h4 className="service-heading">Lorem ipsum</h4>
              <p className="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam architecto quo inventore harum ex magni, dicta impedit.</p>
            </div>
          </div>
        </div>
              ...
              <ul className="timeline">
                <li>
                  ...
                  <div className="timeline-panel">
                    <div className="timeline-heading">
                      <h4>2009-2011</h4>
                      <h4 className="subheading">Quando começamos</h4>
                    </div>
                ...
                <li className="timeline-inverted">
                  ...
                  <div className="timeline-panel">
                    <div className="timeline-heading">
                      <h4>Março 2011</h4>
                      <h4 className="subheading">Nascimento da agência</h4>
                    </div>
                    <div className="timeline-body">
                      <p className="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>
                    </div>
                ...
                <li>
                  ...
                  <div className="timeline-panel">
                    <div className="timeline-heading">
                      <h4>Dezembro 2012</h4>
                      <h4 className="subheading">Expansão</h4>
                    </div>
                    <div className="timeline-body">
                      <p className="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>
                    </div>
                ...
                <li className="timeline-inverted">
                  ...
                  <div className="timeline-panel">
                    <div className="timeline-heading">
                      <h4>Julho 2014</h4>
                      <h4 className="subheading">Outros Serviços</h4>
                    </div>
                    <div className="timeline-body">
                      <p className="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>
                    </div>
      ...
      <section className="page-section" id="contact">
        <div className="container">
          <div className="row">
            <div className="col-lg-12 text-center">
              <h2 className="section-heading text-uppercase">Entre em contato</h2>
              <h3 className="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3>
            </div>
          </div>
          <div className="row">
